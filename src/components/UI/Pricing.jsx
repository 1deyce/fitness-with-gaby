        ...
        <section className="bg-black">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
                    {/* <!-- Pricing Card --> */}
                    <div className="flex flex-col p-6 mx-auto md:w-[500px] max-w-lg text-center text-white bg-black rounded-lg border-2 border-[--heading-color] shadow xl:p-8">
                  ...
                  >
                    ...
                    {/* <!-- Pricing Card --> */}
                    <div className="flex flex-col p-6 mx-auto max-w-lg md:w-[500px] text-center text-white bg-black rounded-lg border-2 border-[--heading-color] shadow xl:p-8">
                        <h3 className="mb-4 text-2xl font-semibold">
                            Sport Massage
                        </h3>
                        <p className="font-light text-center text-gray-500 sm:text-lg dark:text-gray-400">
