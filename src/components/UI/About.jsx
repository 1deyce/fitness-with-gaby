                ...
                <div>
                  ...
                  <ul className="mb-16 space-y-4 text-left">
                    ...
                    <li className="flex items-center space-x-3">
                        ...
                        <span className="text-white text-xl">Bachelor of Arts <span className="text-[--heading-color]">(BA Hons)</span> Sport and Exercise Science</span>
                    </li>
                    <li className="flex items-center space-x-3">
                        <svg 
                          className="flex-shrink-0 w-5 h-5 text-[--heading-color]" 
                ...
                {/* Experience */}
                  ...
                  <ul className="mb-8 space-y-4 text-left">
                    ...
                    <li className="flex items-center space-x-3">
                        ...
                        <span className="text-white text-xl">Strength and Conditioning Intern - 6 months <span className="text-[--heading-color]">(Cape Town City F.C)</span></span>
                    </li>
                  </ul>
                </div>
              </div>
