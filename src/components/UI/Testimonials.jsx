                    ...
                    <figure className="mt-10">
                        ...
                        <figcaption className="mt-10">
                            <img
                                ...
                                alt=""
                            />
                            <div className="mt-4 flex items-center justify-center space-x-3 text-base pb-5">
                                <div className="font-semibold text-white">Amy-Leigh Haas</div>
                                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
                                    <circle cx={1} cy={1} r={1} />
                                </svg>
                                <div className="text-white">Bootcamp Client</div>
                            </div>
                        </figcaption>
                    </figure>
                </div>
