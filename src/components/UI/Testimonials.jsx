                    ...
                    <blockquote className="rounded-lg bg-black border-2 border-[--heading-color] p-6 shadow-sm sm:p-8">
                        <div className="flex items-center text-center justify-center gap-4">
                            <div>
                                ...
                                <p className="mt-0.5 text-xl text-center font-bold text-white border-b border-[--heading-color] inline-block">Amy-Leigh</p>
                            </div>
                        </div>
                    ...
                    <blockquote className="rounded-lg bg-white p-6 shadow-sm sm:p-8">
                        <div className="flex items-center text-center justify-center gap-4">
                            <div>
                                ...
                                <p 
                                    className="mt-0.5 text-xl inline-block font-bold text-black border-b border-[--heading-color]"
                                >
                                    Lyle
                                </p>
                            </div>
                        ...
                        <p className="mt-2 text-black text-center leading-5">
                            Best sports massage I've ever experienced! Gaby sorted out my tense back from a CrossFit injury by diving into each muscle group and layer. I loved her interactive discussions about the back muscles and her bubbly personality! I would highly recommend her! Very professional, friendly and affordable! 
                        </p>
                    </blockquote>
                    ...
                    <blockquote className="rounded-lg bg-black border-2 border-[--heading-color] p-6 shadow-sm sm:p-8">
                        <div className="flex items-center text-center justify-center gap-4">
                            <div>
                                ...
                                <p className="mt-0.5 text-xl text-center font-bold text-white border-b border-[--heading-color] inline-block">Romaine</p>
                            </div>
                        </div>
                        <p className="text-center font-semibold text-[--heading-color] mt-1">
                            Personal Training
