...
const Navbar = ({ toggleMenu, handleLinkClick }) => {
  return (
    <nav onClick={toggleMenu}>
      <ul className='menu hidden md:block'>
        ...
        <li>
          <button onClick={() => handleLinkClick('/bookings')}>Bookings</button>
        </li>
        <li>
    ...
    <header>
      <div className="container">
        <div className="nav__wrapper">
          ...
          {/* Navigation links */}
          <div className={`navigation flex items-center gap-10 ${isMobile ? 'bg-[#3cc4bd]' : ''}`}>
            <Navbar toggleMenu={toggleMenu} handleLinkClick={handleLinkClick} />
          </div>
          {/* Additional items on the right */}
          <div className="nav__right flex items-center gap-4">
            <span
